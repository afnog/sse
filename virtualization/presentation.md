...
* Use the [Security](http://docs.openstack.org/kilo/install-guide/install/apt/content/ch_basic_environment.html#basics-security) to create a password. Use this password for everything.
